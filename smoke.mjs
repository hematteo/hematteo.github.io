...
try {
  ...
  check('apps link to their own sites', await page.locator('#apps a[href="https://3dgameoflife.com/"]').count() >= 2 && await page.locator('#apps a[href="https://haopai.app/"]').count() >= 2 && await page.locator('.masthead a[href="#apps"]').count() === 1)
  check('small apps link to their own pages', await page.locator('#small-apps a[href="/matrix-rain/"]').count() >= 2 && await page.locator('#small-apps a[href="/matrix-cave/"]').count() >= 2)
